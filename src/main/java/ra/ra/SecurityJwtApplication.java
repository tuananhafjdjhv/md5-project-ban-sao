...
import ra.entities.entity.*;
import ra.repositories.*;
...
//			roleAdmin.setName(RoleName.valueOf("ROLE_CLIENT"));
//			roles.add(roleAdmin);
//			admin.setName("Tuấn Anh");
...
//			Movie doremon = addNewMovie("Doraemon: Ôi Bạn Ơi 2",
...
//				schedule.setRoom(r1);
//				schedule.setStartDate(LocalDate.parse("2023-01-05"));
